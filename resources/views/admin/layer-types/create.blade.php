        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xl-10 mx-auto">
                    ...
                    <h6 class="mb-0 text-uppercase">Add Layer Type</h6>
                    <hr/>
...
{{--                            </div>--}}
                            ...
                            <form class="row g-4" method="POST" action="{{ route('layerType.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-12 mt-3">
                                    <button type="submit" class="btn btn-danger px-5">Save Layer type</button>
